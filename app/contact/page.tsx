                ...
                <CardContent className="space-y-6">
                  <div className="flex items-center space-x-4 p-4 bg-yellow-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <a href="tel:+33659128819" className="text-2xl font-bold text-yellow-600 hover:text-yellow-700" aria-label="Appeler au +33 6 59 12 88 19">
                        +33 6 59 12 88 19
                      </a>
              ...
              <Card className="bg-yellow-500">
                <CardContent className="p-6 text-center">
                  ...
                  <Button size="lg" className="bg-black hover:bg-gray-800 text-white font-bold">
                    ...
                    <a href="tel:+33659128819" aria-label="Appeler maintenant pour une intervention immédiate">
                      APPELER MAINTENANT
                    </a>
                  </Button>
                </CardContent>
