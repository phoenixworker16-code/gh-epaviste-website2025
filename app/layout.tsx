...
export const metadata: Metadata = {
  ...
  description:
    "Service d'enlèvement gratuit et rapide d'épaves agréé VHU en Île-de-France. Intervention 24/7, certificat de destruction fourni.",
  keywords: "épaviste, enlèvement épave, gratuit, Île-de-France, VHU, destruction voiture, certificat destruction",
  icons: {
  ...
  openGraph: {
    ...
    description: "Service d'enlèvement gratuit et rapide d'épaves agréé VHU en Île-de-France",
      ...
      <body className={`${inter.className} antialiased`}>
        ...
        <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
          <div className="container mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <Link href="tel:+33659128819" className="bg-yellow-500 hover:bg-yellow-600 text-black font-bold px-4 py-2 rounded flex items-center transition">
