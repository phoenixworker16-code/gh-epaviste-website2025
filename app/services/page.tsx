...
export const metadata: Metadata = {
  ...
  description: "Découvrez nos services d'enlèvement gratuit d'épaves en Île-de-France : voitures, motos, utilitaires. Agréé VHU, intervention rapide 24/7.",
  keywords: "services épaviste, enlèvement épave gratuit, destruction voiture, VHU, Île-de-France, certificat destruction",
  openGraph: {
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  ...
                  <ul className="space-y-2 text-sm" aria-label="Avantages de l&apos;enlèvement gratuit">
                    ...
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-500" aria-hidden="true" />
                      <span>Équipe professionnelle et agréée</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl text-center text-black">Certificat de Destruction</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 text-center mb-4">
                    Remise du certificat de destruction officiel pour vos démarches administratives.
                  </p>
                  <ul className="space-y-2 text-sm" aria-label="Détails du certificat de destruction">
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-500" aria-hidden="true" />
                    ...
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-500" aria-hidden="true" />
                      <span>Remis immédiatement sur place</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-500" aria-hidden="true" />
                      <span>Conforme à la réglementation VHU</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl text-center text-black">Service Agréé VHU</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 text-center mb-4">
                    Destruction écologique conforme aux normes VHU (Véhicules Hors d&apos;Usage).
                  </p>
                  <ul className="space-y-2 text-sm" aria-label="Avantages du service agréé VHU">
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-500" aria-hidden="true" />
                    ...
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-500" aria-hidden="true" />
                      <span>Respect strict de l&apos;environnement</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-500" aria-hidden="true" />
                      <span>Recyclage optimal et traçable</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" className="bg-white hover:bg-gray-100 text-black font-bold" asChild>
                <a href="tel:+33659128819" aria-label="Appeler GH Épaviste au +33 6 59 12 88 19">
