...
export const metadata = {
  ...
  description: "Guide étape par étape pour l'enlèvement gratuit de votre épave par GH Épaviste, centre VHU agréé en Île-de-France.",
};
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="container mx-auto px-4 py-6 max-w-3xl flex-1">
        ...
        <p className="mb-8 text-black text-center">
          Vous avez une épave qui encombre votre garage ou votre jardin et vous souhaitez vous en débarrasser ? GH Épaviste, votre centre VHU agréé, vous accompagne à chaque étape pour un enlèvement gratuit, rapide et conforme à la législation. Suivez ce guide simple pour nous aider à prendre en charge votre véhicule hors d&apos;usage (VHU) en toute sérénité.
        </p>
        ...
        <ol className="space-y-10 list-decimal list-inside">
          <li>
            ...
            <p className="text-black">
              ...
              <a href="tel:+33659128819" className="text-yellow-500 font-bold underline ml-1">
                <Phone className="inline w-4 h-4 mr-1" />+33 6 59 12 88 19
              </a>
              {" "}ou via notre{" "}
          ...
          <li>
            ...
            <p className="text-black">
              Pour que l&apos;enlèvement de votre épave se déroule sans encombre et dans le respect des normes administratives, certains documents sont indispensables. Veuillez les préparer avant notre arrivée :
            </p>
            <ul className="list-disc list-inside ml-4 mt-2 text-black">
              <li>
              ...
              <li>
                ...
                <a
                  href="https://siv.interieur.gouv.fr/map-usg-public/fr/demarche/demarches_recherche"
                  target="_blank"
              ...
              <li>
                <strong>Déclaration de cession pour destruction</strong> : Cerfa n°15776*02 à remplir le jour J (nous l&apos;apportons, ou&nbsp;
                <a
          ...
          <li>
            ...
            <p className="text-black">
              Une fois les documents vérifiés et l&apos;épave chargée, nous vous remettrons un certificat de destruction officiel. Ce document vous dégage de toute responsabilité et met fin à votre contrat d&apos;assurance. Pensez à le transmettre à votre assureur.
            </p>
          </li>
        </ol>
      </main>
        ...
        <div className="container mx-auto px-4 flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-4">
            <a
              ...
              aria-label="Appeler GH Épaviste au +33 6 59 12 88 19"
            >
