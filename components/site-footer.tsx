...
export default function SiteFooter() {
  return (
    <footer className="bg-[#0a0a0a] text-white pt-12 pb-6 border-t border-gray-800 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-6 mb-10">
          ...
          <div className="lg:col-span-4">
            <Image
              ...
              loading="lazy"
            />
            <p className="text-gray-400 mb-4 text-sm max-w-sm">
            ...
            <ul className="space-y-1 text-sm">
              {[
                ...
                <li key={idx}>
                  <Link
                    href={link.href}
                    className="py-1.5 text-gray-400 hover:text-yellow-500 transition-all duration-300 flex items-center group min-h-[44px]"
                  >
              ...
              <li className="flex items-start gap-3 hover:text-white transition-colors">
                ...
                <div>
                  <a
                    ...
                    className="block font-bold text-base text-white hover:text-yellow-500 transition-colors min-h-[44px] flex items-center"
                  >
                    07 53 12 07 93
                  </a>
            ...
            <ul className="space-y-1 text-sm">
              <li>
                <Link
                  ...
                  className="py-1.5 inline-flex items-center min-h-[44px] text-gray-400 hover:text-white transition-colors underline-offset-4 hover:underline"
                >
                  Mentions Légales
                </Link>
              </li>
